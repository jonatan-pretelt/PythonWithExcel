...
df = pd.read_csv('crime.csv', encoding='utf-8', dtype={"INCIDENT_NUMBER": str, "OFFENSE_CODE": str, "SHOOTING": str, "YEAR": str, "MONTH:": str,
...
per_crimes = round(perc_crimes, 2)

ws['O8'].value = total_crimes
ws['P8'].value = counterfeit
ws['Q8'].value = per_crimes
